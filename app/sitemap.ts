...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/combine`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/dosage`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/calculators`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/calculators/timing`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${BASE}/calculators/beta-alanine`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/calculators/citrulline`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/calculators/caffeine`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${BASE}/calculators/rpe`, lastModified: now, changeFrequency: 'monthly', priority: 0.7 },
    ...
    { url: `${BASE}/peptides`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/sleep`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
  ]
