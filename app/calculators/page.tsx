        ...
        <div className="mt-4 grid gap-3">
          ...
          >
            <div className="min-w-0">
              ...
              <p className="text-xs text-lab-muted leading-snug mt-1">
                The whole aisle on one page — the evidence-based dose, timing and form for every major supplement, and where more stops helping.
              </p>
            </div>
          ...
          >
            <div className="min-w-0">
              ...
              <p className="text-xs text-lab-muted leading-snug mt-1">
                Can you take these together? Honest verdicts on mixing your supplements, plus the caffeine and double-dosing traps.
              </p>
            </div>
            <span className="text-lab-lime text-lg font-black shrink-0 group-hover:translate-x-1 transition-transform">→</span>
          </Link>
          ...
          >
            <div className="min-w-0">
              ...
              <p className="text-xs text-lab-muted leading-snug mt-1">
                Your effective pre-workout dose, then a half-life clock for when to stop before bed.
              </p>
            </div>
            <span className="text-lab-lime text-lg font-black shrink-0 group-hover:translate-x-1 transition-transform">→</span>
          </Link>
          ...
          >
            <div className="min-w-0">
              ...
              <p className="text-xs text-lab-muted leading-snug mt-1">
                Enter your target weight and bar — see the exact plates to load on each side.
              </p>
            </div>
            <span className="text-lab-lime text-lg font-black shrink-0 group-hover:translate-x-1 transition-transform">→</span>
          </Link>
          ...
          >
            <div className="min-w-0">
              ...
              <p className="text-xs text-lab-muted leading-snug mt-1">
                Rate a set by reps and RPE to estimate your 1RM, then get the load for your next set.
              </p>
            </div>
            <span className="text-lab-lime text-lg font-black shrink-0 group-hover:translate-x-1 transition-transform">→</span>
          </Link>
          ...
          >
            <div className="min-w-0">
              ...
              <p className="text-xs text-lab-muted leading-snug mt-1">
                Your Body Mass Index in seconds — plus the honest reason lifters should not trust it.
              </p>
            </div>
            <span className="text-lab-lime text-lg font-black shrink-0 group-hover:translate-x-1 transition-transform">→</span>
          </Link>
