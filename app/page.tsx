...
export const metadata: Metadata = {
  ...
  "alternates": {
    "canonical": "https://www.theliftinglab.co.uk"
  },
  "openGraph": {
    "title": "The Lifting Lab — Supplement research",
    "description": "Browse supplement labels, unverified historical records and listed prices. Approved effectiveness recommendations are unavailable; manual research stacks remain usable.",
...
const orgLd = {
  ...
  description:
    'UK supplement research records and listed-price comparisons. No approved effectiveness assessment is available.',
  sameAs: [
    ...
    <div className="min-h-screen bg-lab-bg text-white">
      ...
      <div className="max-w-[860px] mx-auto px-4 pt-6 pb-20 space-y-5">
        ...
        <div className="bg-lab-panel border border-lab-border rounded-xl px-4 py-4 space-y-2">
          ...
          <p className="text-xs text-white/60 leading-relaxed">No approved effectiveness assessment is available. Historical percentages are unverified and do not establish dosing, product quality or a recommendation. Labels and listed prices remain available for research.</p>
