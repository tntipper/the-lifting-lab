...
COMMIT;
SELECT jsonb_build_object('queryId','tll-staging-generation-20-retirement-postcommit/v1','projectRef','qdmvngjwkcsilzmqksme','generation',20,'windowId','a009f2b4-86df-4701-a8bc-1112597e3c42','status','PASS_RETIRED','runtimeRoles',5,'runtimeSessions',0,'controlsEnabled',0,'passwordsConfigured',0,'executionEdges',0,'operatorEdges',5) AS tll_gen20_retirement_postcommit;
