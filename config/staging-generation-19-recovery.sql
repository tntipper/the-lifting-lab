-- GENERATED by scripts/staging-generation-19-recovery.mjs from the pinned generation-6 recovery; do not edit.
...
BEGIN
  IF current_setting('tll.recovery_idempotent',true)<>'true' THEN
    ...
    marker:='tll-runtime-window/v1 '||jsonb_build_object('expiresAt',current_setting('tll.recovery_expires_at',true),'generation',19,'projectRef','qdmvngjwkcsilzmqksme','state','retired','windowId','51809dd4-bd4b-44c7-8609-7dd8ca063679')::text;
    FOREACH r IN ARRAY ARRAY['tll_customer_runtime','tll_cart_runtime','tll_broker_runtime','tll_provisional_runtime','tll_bridge_runtime'] LOOP
