...
The exact [42-line arming preview](../arming-previews/2026-09-25-stage3-metadata-aa1834f.patch) was generated from disabled source commit `aa1834f0d22a1a6fb185bfa4bbc5610cbb75a4ce`; SHA-256 `b9b004fafe49444fc37569d7204964a2456785559a0566d55ca2f57f00b083d1`. `git apply --check` passed. It changes only the Swift gate, launcher gate and their two activation-manifest hashes. This patch is **not applied**. Any source drift invalidates the preview and requires regeneration and review.
