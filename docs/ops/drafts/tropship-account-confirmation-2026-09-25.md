...
4. **Exact product information before online sale.** For each `ProductCode`, can you supply or link the current manufacturer label or specification for that exact barcode, flavour and pack size, including ingredients, allergens, nutrition and required warnings? Please tell us when those details change. If you cannot provide them, please identify the manufacturer source we should use. May we display the product images you supply on our site? We will write our own product-page descriptions.
