...
const disabledActivationToolingSources = [
  ...
  'scripts/staging-provider-broker-phased-session.mjs',
  'scripts/staging-provider-broker-rotation-process-control.mjs',
  'scripts/staging-provider-broker-rotation-keychain.py',
  'scripts/staging-provider-broker-rotation-readiness.mjs',
  'scripts/staging-provider-broker-reconciliation.mjs',
  'scripts/staging-provider-broker-recovery-collection.mjs',
  'scripts/staging-provider-broker-recovery-read-journal.mjs',
  'scripts/staging-provider-broker-recovery-read-session.mjs',
  'scripts/staging-provider-broker-recovery-read-bindings.mjs',
  'scripts/staging-provider-broker-recovery-read-live-launcher.mjs',
  'scripts/staging-provider-broker-recovery-read-keychain.py',
  'scripts/staging-provider-broker-recovery-process-control.mjs',
  ...
  'tests/staging-provider-broker-phased-session.test.mjs',
  ...
  'tests/staging-provider-broker-recovery-read-session.test.mjs',
  'tests/staging-provider-broker-recovery-read-bindings.test.mjs',
  'tests/staging-provider-broker-recovery-process-control.test.mjs',
...
const manifest = {
  ...
  disabledActivationTooling: {
    ...
    deploymentCreationHoldReason: 'PREVIEW_VERIFIER_NOT_JOURNALED_OR_CONNECTED',
