/**
 * Secret-free Generation 17 connection-failure / recovery evidence helpers.
 *
...
export const CONNECTION_FAILURE_EVIDENCE_SCHEMA = 'tll-generation-17-connection-failure/v1'
export const DEFAULT_CONNECTION_FAILURE_EVIDENCE_PATH = fileURLToPath(
  new URL('../../implementation-state/staging/tll-generation-17-connection-failure.json', import.meta.url),
)
