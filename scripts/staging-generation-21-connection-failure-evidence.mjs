/**
 * Secret-free Generation 21 connection-failure / recovery evidence helpers.
 *
...
export const CONNECTION_FAILURE_EVIDENCE_SCHEMA = 'tll-generation-21-connection-failure/v1'
export const DEFAULT_CONNECTION_FAILURE_EVIDENCE_PATH = fileURLToPath(
  new URL('../../implementation-state/staging/tll-generation-21-connection-failure.json', import.meta.url),
)
...
export function projectSecretFreeConnectionFailure(value) {
  ...
  // Always stamp non-secret pooler endpoint constants when projecting Gen21 evidence.
 ...
 * uses Gen21 RECOVERY_* evidence fields and adds failureReason for zero-sessions.
 */
