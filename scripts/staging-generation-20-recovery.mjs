...
const successor=Object.freeze({generation:20,windowId:'a009f2b4-86df-4701-a8bc-1112597e3c42'})
// No Gen20 credential window exists in Phase 1. A reviewed arming diff must
...
const files=Object.freeze([
  Object.freeze({source:'config/staging-account-activation-recovery.sql',sourceSha256:'69b6cae3da32c62512008e14c3fb6c68746e9ee533a1dedcaa690ff349fea87c',output:'config/staging-generation-20-recovery.sql'}),
  Object.freeze({source:'config/staging-account-activation-recovery-postcommit.sql',sourceSha256:'278953bd725c9ccdba2e2da0faaafac76aafd94e65234e1fa0c62d68b1d78d35',output:'config/staging-generation-20-recovery-postcommit.sql'}),
])
const unavailable=()=>{throw new Error('Generation-20 recovery generation unavailable')}
...
function transform(value){
  ...
  value=replaceRequired(value,'-- GENERATED by scripts/staging-account-activation-recovery.mjs; do not edit.','-- GENERATED by scripts/staging-generation-20-recovery.mjs from the pinned generation-6 recovery; do not edit.')
...
SELECT jsonb_build_object('queryId','tll-staging-generation-20-retirement-postcommit/v1','projectRef','qdmvngjwkcsilzmqksme','generation',20,'windowId','${successor.windowId}','status','PASS_RETIRED','runtimeRoles',5,'runtimeSessions',0,'controlsEnabled',0,'passwordsConfigured',0,'executionEdges',0,'operatorEdges',5) AS tll_gen20_retirement_postcommit;
`)
  }
...
if(process.argv.includes('--check')){
  ...
  if(stale){console.error('generation-20 recovery artifact is stale');process.exitCode=1}
