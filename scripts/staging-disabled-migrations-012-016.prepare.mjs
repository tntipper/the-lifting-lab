...
function writeArtifacts () {
  ...
  writeFileSync(resolve(root, 'config/staging-disabled-migrations-012-016.sql'), pkg.sql, { mode: 0o644 })
  writeFileSync(resolve(root, 'config/staging-disabled-migrations-012-016.json'), JSON.stringify({ schema: `${INSTALL_ID}/manifest`, target: pkg.target, productionExcluded: pkg.productionExcluded, nativeAccessApproved: false, sourcePins: pkg.sources, transactionSha256: pkg.sqlSha256, transport: { hostname: 'api.supabase.com', path: `/v1/projects/${PROJECT_REF}/database/query`, method: 'POST', redirects: false, maxAgeMs: 60000, maxRequests: 1 } }, null, 2) + '\n', { mode: 0o644 })
}
