...
import { INERT_VALID_UNTIL, PROJECT_REF, PACKAGE_ID, WINDOW_ID } from './staging-generation-6-credentials.mjs'

export const NATIVE_DATABASE_TRANSPORT_ENABLED = true
