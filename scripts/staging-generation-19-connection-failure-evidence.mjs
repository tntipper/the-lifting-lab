/**
 * Secret-free Generation 19 connection-failure / recovery evidence helpers.
 *
...
export const CONNECTION_FAILURE_EVIDENCE_SCHEMA = 'tll-generation-19-connection-failure/v1'
export const DEFAULT_CONNECTION_FAILURE_EVIDENCE_PATH = fileURLToPath(
  new URL('../../implementation-state/staging/tll-generation-19-connection-failure.json', import.meta.url),
)
 ...
 * inherits Gen 15 RECOVERY_* evidence fields and adds failureReason for zero-sessions.
 */
