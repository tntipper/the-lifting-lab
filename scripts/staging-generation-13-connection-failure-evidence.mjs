/**
 * Secret-free Generation 13 connection-failure evidence helpers.
 *
...
export const CONNECTION_FAILURE_EVIDENCE_SCHEMA = 'tll-generation-13-connection-failure/v1'
export const DEFAULT_CONNECTION_FAILURE_EVIDENCE_PATH = fileURLToPath(
  new URL('../../implementation-state/staging/tll-generation-13-connection-failure.json', import.meta.url),
)
