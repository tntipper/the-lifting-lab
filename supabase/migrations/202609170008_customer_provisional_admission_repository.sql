...
BEGIN
  ...
  IF EXISTS(SELECT FROM pg_class c WHERE c.relnamespace='tll_provisional_private'::regnamespace AND c.relkind IN ('r','S')
    AND (c.relowner<>'tll_provisional_owner'::regrole
