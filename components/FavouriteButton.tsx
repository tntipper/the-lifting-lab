...
export default function FavouriteButton({
  ...
  return (
    <button
      ...
      className="shrink-0 p-1 rounded-lg transition-colors disabled:opacity-40 text-lab-muted hover:text-white"
    >
      <svg
        viewBox="0 0 24 24"
        className={dim}
        fill={favourited ? '#a6e22e' : 'none'}
        stroke={favourited ? '#a6e22e' : 'currentColor'}
        strokeWidth="2"
        strokeLinecap="round"
