...
test('generation 17 native gates are disarmed after zero-sessions runtime_sessions_remain recovery', () => {
  assert.equal(NATIVE_GENERATION_17_TRANSPORT_ENABLED, false)
  assert.equal(NATIVE_GENERATION_17_DATABASE_TRANSPORT_ENABLED, false)
})
