...
} from '../scripts/staging-generation-13-connection-failure-evidence.mjs'
...
test('generation 13 live launcher and run-live-once wire secret-free evidence persistence', () => {
  const launcher = readFileSync('scripts/staging-generation-13-live-launcher.mjs', 'utf8')
  const runOnce = readFileSync('scripts/staging-generation-13-run-live-once.mjs', 'utf8')
