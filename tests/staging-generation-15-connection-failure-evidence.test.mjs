...
} from '../scripts/staging-generation-15-connection-failure-evidence.mjs'
...
test('extractLauncherTerminalFromStdout recovers enriched connectionFailure from launcher line', () => {
  const stdout = [
    '{"event":"run-live-once-start","generation":15}',
...
test('generation 15 live launcher and run-live-once wire secret-free evidence persistence', () => {
  const launcher = readFileSync('scripts/staging-generation-15-live-launcher.mjs', 'utf8')
