...
test('staging account activation manifest pins reviewed sources and contains no secret values', () => {
  ...
  assert.equal(manifest.stageSafety.generation12Armed, true)
  ...
  assert.equal(manifest.generation12Successor.nativeTransportEnabled, true)
  assert.equal(manifest.generation12Successor.status, 'ONE_STAGING_WINDOW_AUTHORIZED')
