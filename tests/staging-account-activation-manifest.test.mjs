...
test('staging account activation manifest pins reviewed sources and contains no secret values', () => {
  ...
  assert.equal(manifest.stageSafety.generation13Armed, true)
  ...
  assert.equal(manifest.generation13Successor.nativeTransportEnabled, true)
  assert.equal(manifest.generation13Successor.status, 'ONE_STAGING_WINDOW_AUTHORIZED')
