...
test('staging account activation manifest pins reviewed sources and contains no secret values', () => {
  ...
  assert.deepEqual(manifest.disabledActivationTooling.sources.map(item => item.path), [
    'scripts/staging-bounded-executor.mjs','scripts/staging-provider-broker-rotation.mjs','scripts/staging-provider-broker-phase-journal.mjs','scripts/staging-provider-broker-reconciliation.mjs','scripts/staging-provider-broker-recovery-collection.mjs','scripts/staging-provider-broker-native-adapter.mjs',
    ...
    'tests/staging-bounded-executor.test.mjs','tests/staging-provider-broker-rotation.test.mjs','tests/staging-provider-broker-phase-journal.test.mjs','tests/staging-provider-broker-reconciliation.test.mjs','tests/staging-provider-broker-recovery-collection.test.mjs','tests/staging-provider-broker-native-adapter.test.mjs',
