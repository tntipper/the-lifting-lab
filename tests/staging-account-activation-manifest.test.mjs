...
test('staging account activation manifest pins reviewed sources and contains no secret values', () => {
  ...
  assert.equal(manifest.stageSafety.generation14Armed, true)
  ...
  assert.equal(manifest.generation14Successor.nativeTransportEnabled, true)
  assert.equal(manifest.generation14Successor.status, 'ONE_STAGING_WINDOW_AUTHORIZED')
