...
test('staging account activation manifest pins reviewed sources and contains no secret values', () => {
  ...
  assert.deepEqual(manifest.disabledActivationTooling.sources.map(item => item.path), [
    ...
    'tests/staging-bounded-executor.test.mjs','tests/staging-provider-broker-rotation.test.mjs','tests/staging-provider-broker-phase-journal.test.mjs','tests/staging-provider-broker-phased-session.test.mjs','tests/staging-provider-broker-rotation-process-control.test.mjs','tests/staging-provider-broker-rotation-keychain.test.mjs','tests/staging-provider-broker-reconciliation.test.mjs','tests/staging-provider-broker-recovery-collection.test.mjs','tests/staging-provider-broker-recovery-read-journal.test.mjs','tests/staging-provider-broker-recovery-read-session.test.mjs','tests/staging-provider-broker-recovery-read-bindings.test.mjs','tests/staging-provider-broker-recovery-process-control.test.mjs','tests/staging-provider-broker-native-adapter.test.mjs',
