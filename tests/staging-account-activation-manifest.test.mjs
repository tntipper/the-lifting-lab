...
test('staging account activation manifest pins reviewed sources and contains no secret values', () => {
  ...
  assert.equal(manifest.stageSafety.generation11Armed, true)
  ...
  assert.equal(manifest.generation11Successor.nativeTransportEnabled, true)
  assert.equal(manifest.generation11Successor.status, 'ONE_STAGING_WINDOW_AUTHORIZED')
