...
test('staging account activation manifest pins reviewed sources and contains no secret values', () => {
  ...
  assert.equal(manifest.generation14Successor.predecessor.expiresAt, '2026-09-21T06:37:00.000Z')
  ...
  assert.equal(manifest.generation14Successor.predecessor.liveReadOnlyConfirmed, false)
  ...
  assert.equal(manifest.generation14Successor.status, 'DISABLED_SUCCESSOR_AWAITING_ARMING_REVIEW')
