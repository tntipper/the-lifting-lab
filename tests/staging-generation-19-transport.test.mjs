...
test('generation 19 is armed for one reviewed window with a fixed nonsecret fingerprint',()=>{
  assert.equal(NATIVE_GENERATION_19_TRANSPORT_ENABLED,true);assert.match(GENERATION_19_SOURCE_FINGERPRINT,/^[a-f0-9]{64}$/)
})
