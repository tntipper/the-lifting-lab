...
const database = Object.freeze({ status: 'PASS', target: 'qdmvngjwkcsilzmqksme', queryId: 'tll-staging-hosted-baseline-database/v2', receiptHash: 'a'.repeat(64), counts: Object.freeze({ migrations: 15, controlsEnabled: 0, runtimeRoles: 5, runtimeSessions: 0, executionEdges: 0, operatorEdges: 5 }) })
