...
test('generation 15-21 recovery successor pins match credentials packages (regresses Gen 17 Gen-16 leftover)', async () => {
  const results = await assertRecoverySuccessorPinsMatchCredentials([15, 16, 17, 18, 19, 20, 21])
  ...
  assert.equal(byGen[21].windowId, 'a5511645-77af-4fc9-9e4c-f5c8a474d5fa')
