...
CREATE ROLE tll_broker_migrator NOLOGIN CREATEROLE;
GRANT CREATE ON DATABASE tll_broker_repository TO tll_broker_migrator;
CREATE SCHEMA auth AUTHORIZATION tll_broker_migrator;
