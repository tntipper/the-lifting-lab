...
import { buildGeneration6CredentialSql, createGeneration6DispatchJournal, IDENTITIES, PACKAGE_ID, PROJECT_REF, WINDOW_ID } from '../scripts/staging-generation-6-credentials.mjs'
