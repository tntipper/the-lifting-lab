...
test('generation 9 is disarmed after recovery with a fixed nonsecret fingerprint',()=>{
  assert.equal(NATIVE_GENERATION_9_TRANSPORT_ENABLED,false);assert.match(GENERATION_9_SOURCE_FINGERPRINT,/^[a-f0-9]{64}$/)
})
